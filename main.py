...
# - pandas: For storing and manipulating tabular data.
#
# Install these packages using pip:
# pip install requests beautifulsoup4 pandas

# PS C:\Users\user\Documents\code alpha\WebScrapper> python .\main.py
#    Index                     Title  Year  ... PG Rating IMDB Rating    IMDB ID
# 0      1  The Shawshank Redemption  1994  ...         A         9.3  tt0111161
# 1      2             The Godfather  1972  ...         A         9.2  tt0068646
# 2      3           The Dark Knight  2008  ...        UA         9.1  tt0468569
# 3      4    The Godfather: Part II  1974  ...         A         9.0  tt0071562
# 4      5              12 Angry Men  1957  ...         U         9.0  tt0050083
